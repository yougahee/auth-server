CREATE TABLE `follow` (
  ...
  CONSTRAINT `user_following_idx` FOREIGN KEY (`user_streamer_idx`) REFERENCES `user` (`user_idx`),
  CONSTRAINT `user_streamer_idx` FOREIGN KEY (`user_follower_idx`) REFERENCES `user` (`user_idx`)
